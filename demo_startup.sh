...
echo "Manager: manager@logicore.demo · demo1234\nDriver:  9876543201 · demo1234 (Phone + PIN)\nSupplier: supplier@logicore.demo · demo1234\nGate:    GATE-001 · demo1234 (Badge ID + PIN)\nPassword for all: demo1234"
echo ""
