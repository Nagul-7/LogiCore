...
echo "Manager: manager@logicore.demo · 123456"
echo "Driver:  9876543201 · 123456 (Phone + PIN)"
echo "Supplier: supplier@logicore.demo · 123456"
echo "Gate:    9000000003 · 123456 (Badge ID + PIN)"
